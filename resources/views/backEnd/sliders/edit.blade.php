                        ...
                        <fieldset class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control live" name="title" id=""
                                     ...
                                     data-class="artical-name" value="{{ $data->title }}">
                                </div>

                                <div class="form-group">
                                    <label for="">content</label>
                                    <textarea  type="text" class="form-control live" data-class="artical-desc" name="content" required> {{ $data->content }} </textarea>
                                </div>
                               <div class="form-group">
                                    <label for="exampleInputEmail1">Sort</label>
                                    <input type="number" min="0" class="form-control" name="sort" value="0" >
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-12 pl-5 pt-2">
                                <div class="card" style="width: 18rem;">
                                    <img id="output" src="{{url($data->img)}}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <strong><h5 class="font-weight-bold artical-name">title</h5></strong>
                                        <p class="card-text artical-desc    ">{{ $data->content }}</p>
                                    </div>
                                </div>
                            </div>
