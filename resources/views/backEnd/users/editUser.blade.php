                                                    ...
                                                    <div class="form-group">
                                                        <hr>
                                                            <div class="form-check form-check-inline ">
                                                                <input class="form-check-input role confirm" type="radio" name="role" id="admin" value="9" @if($data->role == 9) checked @endif>
                                                                <label class="form-check-label" for="admin">admin</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input role confirm" type="radio" name="role" id="moderator" value="2" @if($data->role == 2) checked @endif>
                                                                <label class="form-check-label" for="moderator">moderator</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input role" type="radio" name="role" id="supervisor" value="3" @if($data->role == 3) checked @endif>
                                                                <label class="form-check-label" for="supervisor">supervisor</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input role" type="radio" name="role" id="manger" value="4" @if($data->role == 4) checked @endif>
                                                                <label class="form-check-label" for="manger">manger</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input role" type="radio" name="role" id="user" value="0" @if($data->role == 0) checked @endif>
