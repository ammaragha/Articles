    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center">Add new Artical</h1>
                        ...
                        <fieldset class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  type="text" class="form-control" name="artContent" required></textarea>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 pl-5 pt-2">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <strong><h5 class="font-weight-bold artical-name">Articals name</h5></strong>
