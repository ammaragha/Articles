    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center">Edit Catigory</h1>
                        ...
                        <fieldset class="col-lg-6 col-md-12 offset-lg-3 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="catName" value="{{ $cat->name }}" pattern=".{2,20}" title="2~20 char only" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sort</label>
                                <input type="number" min="0" class="form-control" name="catSort" value="{{ $cat->sort }}" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Description</label>
                                <textarea  type="text" class="form-control" name="catDesc">{{ $cat->description }}</textarea>
                            </div>
